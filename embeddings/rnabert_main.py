...
def seq2emb(seq, seq_id):
  if len(seq)<440:
    ...
    file.close()
    os.system("python /home/gstegmayer/RNABERT/MLM_SFP.py --pretraining bert_mul_2.pth --data_embedding data/input1.fa --embedding_output output/embedding1.txt --batch 40")
    try:
    ...
    file.close()
    os.system("python /home/gstegmayer/RNABERT/MLM_SFP.py --pretraining bert_mul_2.pth --data_embedding data/input2.fa --embedding_output output/embedding2.txt --batch 40")
    try:
